...
void loop()
{
  ...
  // Alteration: Alter the program so that the LED blinks on and off for 1 second, then 2 seconds, then 3 seconds, then 4, then 5, then repeats starting with 1 second
  
  // Blink for one second was already done above in the original program
